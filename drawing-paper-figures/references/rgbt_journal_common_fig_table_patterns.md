...
- [一、几乎所有方法论文都有的部分](#一几乎所有方法论文都有的部分)
- [二、多数方法论文会补的部分](#二多数方法论文会补的部分)
- [三、可选但有辨识度的加分项](#三可选但有辨识度的加分项)
- [四、映射到 CARE-Track 当前实验章](#四映射到-care-track-当前实验章)
- [五、建议形成的 CARE-Track 实验图表骨架](#五建议形成的-care-track-实验图表骨架)
- [六、实验图通用铁律 checklist](#六实验图通用铁律-checklist每张图出图前投稿前逐条过)
